    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="flex flex-col md:flex-row mt-[40px] w-full items-center md:items-start">
                    <p className="text-white font-bodoni-moda italic text-[22px] md:text-[28px] w-full md:w-7/10 p-4 text-center md:text-left">Hop into Keefler's Discord to keep up with when new music is coming or when he goes live on Twitch. Get exclusive early looks at new music, behind the scenes content from the studio, and be a part of creative decisions like voting on cover art and which songs to release. Or just hang out with Keefler and the rest of the community to chat about your favorite things. In addition to providing exclusive content,  Keefler wants his Discord to be a place to chill, chat, game, and relax</p>
                    <div className="relative w-full md:w-3/10 min-w-[250px] md:min-w-[350px] md:ml-4 mt-4 flex flex-col items-center">
                        <div className="relative w-[333px]">
                            <Image src={discord} width={333} className="w-full max-w-[333px] h-auto" />
                            <Image src={discordBlack} className="absolute top-[20px] left-[24px]" width={288} />
                        </div>
                ...
                <div className="bg-[#fe0860] w-full md:h-[350px] py-8 flex flex-col items-center">
                    ...
                    <div className="flex flex-col-reverse items-center md:flex-row md:items-start justify-center w-full px-4">
                        <form className="mt-6 w-full max-w-[455px]">
