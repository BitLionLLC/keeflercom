    ...
    return (
        <div className="relative">
            ...
            <div className="relative z-10 bg-black/20 pt-[60px]">
                ...
                <div className="text-3xl p-6 font-serif flex flex-col gap-6">
                ...
                <div className="text-3xl p-6 font-serif flow-root">
                    <Image src={studio} alt="Keefler in the studio" className="float-right ml-4 object-scale-down max-w-[80%]" />
            ...
            <SocialLinks outerClassName="!mt-2 justify-end" iconClassName="text-white w-[62px] h-[62px] text-[40px]" />
        </div>
    )
}