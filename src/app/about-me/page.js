        ...
        <div className="relative">
            ...
            <div className="relative z-10 bg-black/20 pt-[60px]">
                ...
                <div className="text-3xl p-6 flex flex-col gap-y-6 font-serif">
                    ...
                    <p>Starting with a batch of pop-rap tracks, Keefler released his most well-received song "Bad For Me" in 2023 - a pop/rap/dance song that has become a cult classic within his community. With that, Keefler also released his first ever music video, brilliantly directed by his producer Dalton Wixom. Though the Bad For Me video is just the beginning for this group of creative friends.</p>
