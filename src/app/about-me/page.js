    ...
    return (
        <div className="relative">
            ...
            <div className="relative z-10 bg-black/20 pt-[60px]">
                <h1 className="text-center px-6 font-light italic font-bodoni-moda tracking-wide text-white text-3xl sm:text-4xl md:text-6xl lg:text-[100px]">Who is Keefler</h1>
                <div className="p-6 font-serif flex flex-col gap-6 text-base sm:text-lg md:text-2xl lg:text-3xl leading-relaxed">
                ...
                <div className="p-6 font-serif flow-root text-base sm:text-lg md:text-2xl lg:text-3xl leading-relaxed">
                    <Image src={studio} alt="Keefler in the studio" className="mx-auto my-4 block w-full max-w-[90%] md:float-right md:ml-4 md:mx-0 md:max-w:[80%] object-contain" />
            ...
            <SocialLinks 
                ...
                twitchIconClassName="text-[36px] w-10 h-10 md:text-[62px] md:w-[62px] md:h-[62px]"
